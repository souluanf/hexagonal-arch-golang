...
import (
	...
	application "github.com/souluanf/hexagonal-arch-golang/application"
...
func (mr *MockProductServiceInterfaceMockRecorder) Create(name, price any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenceInterfaceMockRecorder) Save(product any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
